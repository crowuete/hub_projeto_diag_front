...
export default function ViewModulo() {
  ...
  return (
    <main className="p-4 dark:bg-gunmetal">
      <div className='max-w-3xl mx-auto'>
        <h1 className="text-3xl font-bold text-center text-royal-blue dark:text-blue-darknut" >Relatório de Desempenho</h1>
        ...
        <p className="text-gray-700 dark:text-gray-400"><strong>Descrição:</strong> {modulo.descricao}</p>
        ...
        <ul className="mt-2 space-y-2">
          {dimensoes.map((dim, idx) => (
            <li key={idx} className="border-2 p-3 rounded shadow-sm border-gray-light hover:border-blue-darknut hover:-translate-y-1 transition transform duration-500">
              ...
              <p className="text-gray-700 dark:text-gray-400"> Pontuação: {dim.valorFinal}</p>
            </li>
          ))}
        </ul>

        <h1 className="text-2xl font-bold mt-10 text-center text-royal-blue dark:text-blue-darknut">Gráfico Empresarial</h1>
